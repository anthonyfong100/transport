...
class TestMessageDatagram(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        sample_data = "Testing message for datagram"
        cls.message_datagram = MessageDatagram(sample_data, 0)
    ...
    def test_serialize(self):
        self.assertEqual(self.message_datagram.serialize(), {
            ...
            "seq_number": 0,
            "checksum": hash(self.message_datagram.data + str(self.message_datagram.seq_number))
        })
...
class TestAckDatagram(unittest.TestCase):
    ...
    def test_serialize(self):
        self.assertEqual(self.ack_datagram.serialize(), {
            "type": "ack",
            "seq_number": 0,
            "checksum": hash(str(self.ack_datagram.seq_number))
        })
